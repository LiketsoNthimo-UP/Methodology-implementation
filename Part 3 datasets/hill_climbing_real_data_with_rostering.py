...
def hill_climbing(shifts, call_centre_scenario, max_wait, max_cost, max_agents, day_range, max_iteration = 10):
    start = datetime.now()
...
def run_test_case(average_time_to_abandon, sample_size):
    ...
    best_shift, best_history, explored_history = hill_climbing(shifts, call_centre_scenario_minimized, max_wait, max_cost, max_agents, day_range, max_iteration = 250)
